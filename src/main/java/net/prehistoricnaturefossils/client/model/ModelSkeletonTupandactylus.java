...
public class ModelSkeletonTupandactylus extends ModelBase {
    ...
    public ModelSkeletonTupandactylus() {
        ...
        this.body6_r2.cubeList.add(new ModelBox(body6_r2, 65, 30, -0.5F, -0.4F, -1.0F, 1, 1, 2, -0.3F, true));
        this.body6_r2.cubeList.add(new ModelBox(body6_r2, 65, 30, 2.3F, -0.4F, -1.0F, 1, 1, 2, -0.3F, false));
        ...
        this.body7_r3.cubeList.add(new ModelBox(body7_r3, 13, 61, -0.5F, -0.2913F, -0.4F, 1, 2, 2, -0.31F, true));
        this.body7_r3.cubeList.add(new ModelBox(body7_r3, 13, 61, 2.3F, -0.2913F, -0.4F, 1, 2, 2, -0.31F, false));
        ...
        this.head2_r2.cubeList.add(new ModelBox(head2_r2, 0, 0, -0.5F, -0.013F, -14.6601F, 1, 1, 15, 0.0F, false));
