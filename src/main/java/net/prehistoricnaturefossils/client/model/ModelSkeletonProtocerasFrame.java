...
public class ModelSkeletonProtocerasFrame extends ModelBase {
    ...
    public ModelSkeletonProtocerasFrame() {
        this.textureWidth = 80;
        this.textureHeight = 80;

        this.fossil = new ModelRenderer(this);
        this.fossil.setRotationPoint(0.0F, 24.0F, 0.0F);
        this.fossil.cubeList.add(new ModelBox(fossil, 1, 1, -0.5F, -24.7F, 11.7F, 1, 25, 1, -0.21F, false));

        this.cube_r1 = new ModelRenderer(this);
        this.cube_r1.setRotationPoint(-3.3F, -19.5F, -11.2F);
        this.fossil.addChild(cube_r1);
        this.setRotateAngle(cube_r1, 0.0F, 0.3054F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 1, 1, -0.5F, -2.5F, -0.5F, 1, 22, 1, -0.21F, false));

        this.cube_r2 = new ModelRenderer(this);
        this.cube_r2.setRotationPoint(-3.3F, -19.5F, -11.2F);
        this.fossil.addChild(cube_r2);
        this.setRotateAngle(cube_r2, -0.3054F, 0.0F, -1.5708F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 1, 1, -2.4F, -4.0F, -0.5F, 1, 8, 1, -0.21F, false));

        this.cube_r3 = new ModelRenderer(this);
        this.cube_r3.setRotationPoint(0.0F, -16.0F, 12.2F);
        this.fossil.addChild(cube_r3);
        this.setRotateAngle(cube_r3, 0.0F, 0.0F, -1.5708F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 1, 1, 6.5F, -5.0F, -0.5F, 1, 10, 1, -0.21F, false));
        ...
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 17, 16, -0.5F, 0.5F, 0.2F, 1, 1, 6, -0.2F, false));
        ...
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 16, -1, -0.5F, 0.8F, -0.1F, 1, 1, 7, -0.2F, false));
        ...
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 9, -0.5F, 0.4F, -6.0F, 1, 1, 7, -0.204F, false));
        ...
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, -1, 17, -0.5F, -0.289F, -0.6323F, 1, 1, 7, -0.2F, false));
        ...
        this.cube_r8.setRotationPoint(0.0F, -0.9F, -2.8F);
        this.neck3.addChild(cube_r8);
        this.setRotateAngle(cube_r8, -0.5061F, 0.0F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 40, 44, -0.5F, -0.2F, -0.1F, 1, 1, 3, -0.204F, false));
        ...
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 30, 33, -0.5F, 0.5319F, 0.5279F, 1, 1, 4, -0.2F, false));
        ...
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 5, 69, -0.5F, -0.4753F, -1.1709F, 1, 4, 1, -0.204F, false));
        ...
        this.tail.cubeList.add(new ModelBox(tail, 9, 46, -0.5F, 0.5503F, -0.0853F, 1, 1, 3, -0.203F, false));

        this.tail2 = new ModelRenderer(this);
        this.tail2.setRotationPoint(0.0F, -0.0497F, 2.8147F);
        this.tail.addChild(tail2);
        this.setRotateAngle(tail2, -0.5411F, 0.0F, 0.0F);
        this.tail2.cubeList.add(new ModelBox(tail2, 40, 49, -0.5F, 0.5598F, -0.0232F, 1, 1, 3, -0.2F, false));

        this.tail3 = new ModelRenderer(this);
        this.tail3.setRotationPoint(0.0F, 0.0F, 3.0F);
        this.tail2.addChild(tail3);
        this.setRotateAngle(tail3, -0.6109F, 0.0F, 0.0F);
        this.tail3.cubeList.add(new ModelBox(tail3, 61, 33, -0.5F, 0.6F, 0.0F, 1, 1, 2, -0.203F, false));
