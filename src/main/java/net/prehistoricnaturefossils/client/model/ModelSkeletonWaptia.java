...
public class ModelSkeletonWaptia extends ModelBase {
    ...
    public ModelSkeletonWaptia() {
        ...
        this.base2.setRotationPoint(9.8205F, -2.05F, 0.8935F);
        this.fossil.addChild(base2);
        this.setRotateAngle(base2, -0.1745F, 0.0F, -1.5708F);
        this.base2.cubeList.add(new ModelBox(base2, 15, 6, 0.0F, -0.6897F, -1.3613F, 0, 1, 4, 0.0F, false));
        this.base2.cubeList.add(new ModelBox(base2, 0, 0, 0.025F, -0.5897F, -1.8613F, 0, 1, 1, 0.0F, false));

        this.cube_r1 = new ModelRenderer(this);
        this.cube_r1.setRotationPoint(-0.2F, -12.3009F, -7.2081F);
        this.base2.addChild(cube_r1);
        this.setRotateAngle(cube_r1, -0.1309F, 0.0F, 0.0F);
        this.cube_r1.cubeList.add(new ModelBox(cube_r1, 13, 19, 0.175F, 10.9374F, 7.505F, 0, 1, 4, 0.0F, false));
        ...
        this.body5.cubeList.add(new ModelBox(body5, 0, 0, 0.0F, -1.0F, -1.5F, 0, 2, 3, 0.0F, false));
        ...
        this.body6.cubeList.add(new ModelBox(body6, 14, 33, -0.0125F, -0.7011F, -0.0694F, 0, 1, 3, 0.0F, false));
        this.body6.cubeList.add(new ModelBox(body6, 7, 32, 0.0125F, -1.2011F, -0.0694F, 0, 1, 3, 0.0F, false));
        ...
        this.body7.cubeList.add(new ModelBox(body7, 0, 31, 0.0F, -0.6926F, -0.2399F, 0, 1, 3, 0.0F, false));
        ...
        this.cube_r2.setRotationPoint(0.948F, 0.0968F, 4.0348F);
        this.body8.addChild(cube_r2);
        this.setRotateAngle(cube_r2, 0.0582F, 0.4372F, 0.0963F);
        this.cube_r2.cubeList.add(new ModelBox(cube_r2, 8, 28, -0.5F, -0.15F, -1.5F, 1, 0, 3, 0.0F, false));

        this.cube_r3 = new ModelRenderer(this);
        this.cube_r3.setRotationPoint(-0.8296F, -0.0866F, 3.996F);
        this.body8.addChild(cube_r3);
        this.setRotateAngle(cube_r3, -0.0121F, -0.4339F, 0.101F);
        this.cube_r3.cubeList.add(new ModelBox(cube_r3, 14, 29, -0.5F, -0.075F, -1.5F, 1, 0, 3, 0.0F, false));

        this.cube_r4 = new ModelRenderer(this);
        this.cube_r4.setRotationPoint(0.063F, 0.0057F, -0.2351F);
        this.body8.addChild(cube_r4);
        this.setRotateAngle(cube_r4, 0.0131F, 0.0F, 0.0436F);
        this.cube_r4.cubeList.add(new ModelBox(cube_r4, 15, 12, -0.5F, 0.0F, 0.1F, 1, 0, 3, 0.0F, false));
        ...
        this.leftantenna2.addChild(cube_r5);
        this.setRotateAngle(cube_r5, 0.0F, 0.0F, 1.5708F);
        this.cube_r5.cubeList.add(new ModelBox(cube_r5, 0, 17, 13.6113F, -0.75F, 9.3468F, 3, 0, 5, 0.0F, false));
        ...
        this.cube_r6.setRotationPoint(1.4253F, 2.0886F, 3.0F);
        this.carapace2.addChild(cube_r6);
        this.setRotateAngle(cube_r6, 0.0F, 0.0F, 1.309F);
        this.cube_r6.cubeList.add(new ModelBox(cube_r6, 0, 10, 12.7663F, 0.0F, 9.6078F, 4, 0, 6, 0.0F, false));
        ...
        this.cube_r7.setRotationPoint(-8.0F, 0.0F, 17.0F);
        this.bone.addChild(cube_r7);
        this.setRotateAngle(cube_r7, 0.0F, 1.309F, 0.0F);
        this.cube_r7.cubeList.add(new ModelBox(cube_r7, 0, 28, 0.0F, -2.0F, 0.0F, 7, 2, 25, 0.0F, false));

        this.cube_r8 = new ModelRenderer(this);
        this.cube_r8.setRotationPoint(-13.0F, 0.0F, -8.0F);
        this.bone.addChild(cube_r8);
        this.setRotateAngle(cube_r8, 0.0F, -1.3526F, 0.0F);
        this.cube_r8.cubeList.add(new ModelBox(cube_r8, 40, 28, 0.0F, -2.0F, -12.0F, 25, 2, 12, 0.0F, false));

        this.cube_r9 = new ModelRenderer(this);
        this.cube_r9.setRotationPoint(5.0F, 0.0F, -21.0F);
        this.bone.addChild(cube_r9);
        this.setRotateAngle(cube_r9, 0.0F, -0.7854F, 0.0F);
        this.cube_r9.cubeList.add(new ModelBox(cube_r9, 53, 44, 0.7F, -2.0F, 0.7F, 18, 2, 12, 0.003F, false));

        this.base = new ModelRenderer(this);
        this.base.setRotationPoint(-5.0F, -1.85F, -11.75F);
        this.fossil.addChild(base);
        this.setRotateAngle(base, 0.1745F, 0.0F, -1.5708F);
        this.base.cubeList.add(new ModelBox(base, 15, 6, 0.2F, -2.0F, -2.0F, 0, 1, 4, 0.0F, false));
        this.base.cubeList.add(new ModelBox(base, 0, 0, 0.225F, -1.9F, -2.5F, 0, 1, 1, 0.0F, false));
        ...
        this.cube_r10.cubeList.add(new ModelBox(cube_r10, 13, 19, 0.175F, -0.75F, -8.0F, 0, 1, 4, 0.0F, false));

        this.body1 = new ModelRenderer(this);
        this.body1.setRotationPoint(-0.8F, -2.0F, 2.0F);
        this.base.addChild(body1);
        this.setRotateAngle(body1, -0.3054F, 0.0F, 0.0F);
        this.body1.cubeList.add(new ModelBox(body1, 0, 0, 1.0F, 0.0F, 0.0F, 0, 2, 3, 0.0F, false));
        ...
        this.body2.cubeList.add(new ModelBox(body2, 14, 33, 0.5F, -0.5F, 0.0F, 0, 1, 3, 0.0F, false));
        this.body2.cubeList.add(new ModelBox(body2, 7, 32, 0.525F, -1.0F, 0.0F, 0, 1, 3, 0.0F, false));

        this.body3 = new ModelRenderer(this);
        this.body3.setRotationPoint(0.0F, -0.25F, 2.7F);
        this.body2.addChild(body3);
        this.setRotateAngle(body3, -0.3491F, 0.0F, 0.0F);
        this.body3.cubeList.add(new ModelBox(body3, 0, 31, 0.5F, -0.5F, 0.0F, 0, 1, 3, 0.0F, false));
        ...
        this.cube_r11.setRotationPoint(0.0F, 0.5F, 2.0F);
        this.body4.addChild(cube_r11);
        this.setRotateAngle(cube_r11, -0.0436F, 0.4363F, 0.0F);
        this.cube_r11.cubeList.add(new ModelBox(cube_r11, 8, 28, -0.45F, -1.0F, 0.6F, 1, 0, 3, 0.0F, false));

        this.cube_r12 = new ModelRenderer(this);
        this.cube_r12.setRotationPoint(0.0F, 0.5F, 2.0F);
        this.body4.addChild(cube_r12);
        this.setRotateAngle(cube_r12, 0.003F, -0.4346F, 0.0962F);
        this.cube_r12.cubeList.add(new ModelBox(cube_r12, 14, 29, -0.55F, -1.0F, 0.6F, 1, 0, 3, 0.0F, false));

        this.cube_r13 = new ModelRenderer(this);
        this.cube_r13.setRotationPoint(0.0F, 1.0F, -5.0F);
        this.body4.addChild(cube_r13);
        this.setRotateAngle(cube_r13, 0.0F, 0.0F, 0.0436F);
        this.cube_r13.cubeList.add(new ModelBox(cube_r13, 15, 12, -0.5F, -1.5F, 4.75F, 1, 0, 3, 0.0F, false));
        ...
        this.leftantenna.addChild(cube_r14);
        this.setRotateAngle(cube_r14, 0.0F, 0.0F, 1.5708F);
        this.cube_r14.cubeList.add(new ModelBox(cube_r14, 0, 17, 0.0F, -0.75F, -4.5F, 3, 0, 5, 0.0F, false));
        ...
        this.cube_r15.setRotationPoint(1.4253F, 2.0886F, 3.0F);
        this.carapace.addChild(cube_r15);
        this.setRotateAngle(cube_r15, 0.0F, 0.0F, 1.309F);
        this.cube_r15.cubeList.add(new ModelBox(cube_r15, 0, 10, -2.0F, 0.0F, -3.0F, 4, 0, 6, 0.0F, false));
