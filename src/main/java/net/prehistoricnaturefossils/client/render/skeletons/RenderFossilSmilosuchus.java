...
import net.prehistoricnaturefossils.client.model.ModelSkeletonSmilosuchusFrame;
...
public class RenderFossilSmilosuchus extends TileEntitySpecialRenderer<TileEntityFossilSmilosuchus> {
    ...
    private static final ResourceLocation FRAME = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/smilosuchus_frame.png");

    private final ModelSkeletonSmilosuchus modelSkeleton;
    private final ModelSkeletonSmilosuchusFrame modelSkeletonFrame;

    public RenderFossilSmilosuchus() {
        this.modelSkeletonFrame = new ModelSkeletonSmilosuchusFrame();
