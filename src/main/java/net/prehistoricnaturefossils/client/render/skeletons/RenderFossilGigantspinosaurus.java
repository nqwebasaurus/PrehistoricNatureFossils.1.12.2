...
import net.prehistoricnaturefossils.client.model.ModelSkeletonGigantspinosaurusFrame;
...
public class RenderFossilGigantspinosaurus extends TileEntitySpecialRenderer<TileEntityFossilGigantspinosaurus> {
    ...
    private static final ResourceLocation FRAME = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/gigantspinosaurus_frame.png");

    private final ModelSkeletonGigantspinosaurus modelSkeleton;
    private final ModelSkeletonGigantspinosaurusFrame modelSkeletonFrame;

    public RenderFossilGigantspinosaurus() {
        this.modelSkeletonFrame = new ModelSkeletonGigantspinosaurusFrame();
    ...
    public void render(TileEntityFossilGigantspinosaurus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (frame) {
            ...
            GlStateManager.enableAlpha();
            ModelSkeletonGigantspinosaurusFrame modelSkeletonFrame = this.modelSkeletonFrame;
            scale = RenderGigantspinosaurus.getScaler() * RenderDisplayWallMount.scaler;
            GlStateManager.translate(x + 0.5, y + 1.4, z + 0.5);
            GlStateManager.scale(scale,scale,scale);
            GlStateManager.rotate(180, 0F, 0F, 1F);
            GlStateManager.rotate(currentRotation, 0F, 1F, 0F);
