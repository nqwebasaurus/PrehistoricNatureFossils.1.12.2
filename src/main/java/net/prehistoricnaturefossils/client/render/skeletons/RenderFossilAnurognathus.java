...
public class RenderFossilAnurognathus extends TileEntitySpecialRenderer<TileEntityFossilAnurognathus> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/anurognathus_stage1.png");
    private static final ResourceLocation TEXTURE2 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/anurognathus_stage2.png");
    ...
    public void render(TileEntityFossilAnurognathus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonAnurognathus modelSkeleton = this.modelSkeleton;
