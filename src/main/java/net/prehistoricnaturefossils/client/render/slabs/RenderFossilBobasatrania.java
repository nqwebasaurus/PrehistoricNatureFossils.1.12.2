...
import net.prehistoricnaturefossils.client.model.ModelSkeletonBobasatrania;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilBobasatrania;

public class RenderFossilBobasatrania extends TileEntitySpecialRenderer<TileEntityFossilBobasatrania> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/bobasatrania_stage1.png");
    private final ModelSkeletonBobasatrania modelSkeleton;

    public RenderFossilBobasatrania() {
        this.modelSkeleton = new ModelSkeletonBobasatrania();
    }

    @Override
    public void render(TileEntityFossilBobasatrania entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
