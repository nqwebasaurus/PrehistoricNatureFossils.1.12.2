...
import net.prehistoricnaturefossils.client.model.ModelSkeletonWalliserops;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilWalliserops;

public class RenderFossilWalliserops extends TileEntitySpecialRenderer<TileEntityFossilWalliserops> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/walliserops_stage1.png");
    private final ModelSkeletonWalliserops modelSkeleton;

    public RenderFossilWalliserops() {
        this.modelSkeleton = new ModelSkeletonWalliserops();
    }

    @Override
    public void render(TileEntityFossilWalliserops entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
