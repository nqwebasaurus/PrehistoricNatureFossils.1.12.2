...
import net.prehistoricnaturefossils.client.model.ModelSkeletonAkmonistion;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilAkmonistion;

public class RenderFossilAkmonistion extends TileEntitySpecialRenderer<TileEntityFossilAkmonistion> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/akmonistion_stage1.png");
    private final ModelSkeletonAkmonistion modelSkeleton;

    public RenderFossilAkmonistion() {
        this.modelSkeleton = new ModelSkeletonAkmonistion();
    }

    @Override
    public void render(TileEntityFossilAkmonistion entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
