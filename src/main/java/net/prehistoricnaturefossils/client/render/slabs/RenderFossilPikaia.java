...
import net.prehistoricnaturefossils.client.model.ModelSkeletonPikaia;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilPikaia;

public class RenderFossilPikaia extends TileEntitySpecialRenderer<TileEntityFossilPikaia> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/pikaia_stage1.png");
    private final ModelSkeletonPikaia modelSkeleton;

    public RenderFossilPikaia() {
        this.modelSkeleton = new ModelSkeletonPikaia();
    }

    @Override
    public void render(TileEntityFossilPikaia entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
