...
import net.prehistoricnaturefossils.client.model.ModelSkeletonCharnia;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilCharnia;

public class RenderFossilCharnia extends TileEntitySpecialRenderer<TileEntityFossilCharnia> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/charnia_stage1.png");
    private final ModelSkeletonCharnia modelSkeleton;

    public RenderFossilCharnia() {
        this.modelSkeleton = new ModelSkeletonCharnia();
    }

    @Override
    public void render(TileEntityFossilCharnia entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        ModelSkeletonCharnia modelSkeleton = this.modelSkeleton;
