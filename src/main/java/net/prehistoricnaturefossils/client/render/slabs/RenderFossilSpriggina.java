...
import net.prehistoricnaturefossils.client.model.ModelSkeletonSpriggina;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilSpriggina;

public class RenderFossilSpriggina extends TileEntitySpecialRenderer<TileEntityFossilSpriggina> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/spriggina_stage1.png");
    private final ModelSkeletonSpriggina modelSkeleton;

    public RenderFossilSpriggina() {
        this.modelSkeleton = new ModelSkeletonSpriggina();
    }

    @Override
    public void render(TileEntityFossilSpriggina entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
