...
import net.prehistoricnaturefossils.client.model.ModelSkeletonSchinderhannes;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilSchinderhannes;

public class RenderFossilSchinderhannes extends TileEntitySpecialRenderer<TileEntityFossilSchinderhannes> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/schinderhannes_stage1.png");
    private final ModelSkeletonSchinderhannes modelSkeleton;

    public RenderFossilSchinderhannes() {
        this.modelSkeleton = new ModelSkeletonSchinderhannes();
    }

    @Override
    public void render(TileEntityFossilSchinderhannes entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
