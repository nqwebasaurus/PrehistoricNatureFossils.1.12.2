...
import net.prehistoricnaturefossils.client.model.ModelSkeletonHaikouichthys;
import net.prehistoricnaturefossils.client.render.general.RenderArrows;
import net.prehistoricnaturefossils.tile.TileEntityFossilHaikouichthys;

public class RenderFossilHaikouichthys extends TileEntitySpecialRenderer<TileEntityFossilHaikouichthys> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/haikouichthys_stage1.png");
    private final ModelSkeletonHaikouichthys modelSkeleton;

    public RenderFossilHaikouichthys() {
        this.modelSkeleton = new ModelSkeletonHaikouichthys();
    }

    @Override
    public void render(TileEntityFossilHaikouichthys entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
