...
public class RenderFossilMixopterus extends TileEntitySpecialRenderer<TileEntityFossilMixopterus> {
    ...
    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/mixopterus_stage1.png");
    private final ModelSkeletonMixopterus modelSkeleton;

    public RenderFossilMixopterus() {
        this.modelSkeleton = new ModelSkeletonMixopterus();
    }

    @Override
    public void render(TileEntityFossilMixopterus entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
