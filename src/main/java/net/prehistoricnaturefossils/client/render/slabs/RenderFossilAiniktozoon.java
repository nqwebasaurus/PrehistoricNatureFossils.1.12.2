...
public class RenderFossilAiniktozoon extends TileEntitySpecialRenderer<TileEntityFossilAiniktozoon> {

    private static final ResourceLocation TEXTURE1 = new ResourceLocation(PrehistoricNatureFossils.MODID + ":textures/skeletons/ainiktozoon_stage1.png");
    private final ModelSkeletonAiniktozoon modelSkeleton;

    public RenderFossilAiniktozoon() {
        this.modelSkeleton = new ModelSkeletonAiniktozoon();
    }

    @Override
    public void render(TileEntityFossilAiniktozoon entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
