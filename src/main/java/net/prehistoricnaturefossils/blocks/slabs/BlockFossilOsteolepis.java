...
public class BlockFossilOsteolepis extends BlockSlabBase implements IArchiveVertebrate {
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityFossilOsteolepis();
    }
    ...
    public CustomTrigger getModTrigger() {
        return ModTriggers.OSTEOLEPIS_COMPLETE;
    }
