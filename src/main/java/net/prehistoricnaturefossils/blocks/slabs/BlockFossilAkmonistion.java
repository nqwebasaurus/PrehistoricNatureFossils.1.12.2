...
public class BlockFossilAkmonistion extends BlockSlabBase {

    public BlockFossilAkmonistion() {
        setRegistryName(PrehistoricNatureFossils.MODID, "skeleton_akmonistion");
        setTranslationKey("pf_skeleton_akmonistion");
        GameRegistry.registerTileEntity(TileEntityFossilAkmonistion.class, PrehistoricNatureFossils.MODID + ":tileentityskeleton_akmonistion");
    ...
    public String getDNACompat() {
        return "mobdnaPNlepidodendron:prehistoric_flora_akmonistion";
    }

    @SideOnly(Side.CLIENT)
    @Override
    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
        tooltip.add("When completed contains " + new TileEntityFossilAkmonistion().getStages() + " part(s)");
    ...
    public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileEntityFossilAkmonistion();
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (playerIn.getHeldItemMainhand().getItem() == Item.getItemFromBlock(this)) {
            if (!worldIn.isRemote) {
                ...
                if (tileEntity != null) {
                    if (tileEntity instanceof TileEntityFossilAkmonistion) {
                        if (((TileEntityFossilAkmonistion) tileEntity).getStages() >= newStage) {
