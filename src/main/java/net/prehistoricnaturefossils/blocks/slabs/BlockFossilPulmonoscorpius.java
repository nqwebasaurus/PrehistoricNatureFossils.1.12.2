...
public class BlockFossilPulmonoscorpius extends BlockSlabBase {

    public BlockFossilPulmonoscorpius() {
        setRegistryName(PrehistoricNatureFossils.MODID, "skeleton_pulmonoscorpius");
        setTranslationKey("pf_skeleton_pulmonoscorpius");
        GameRegistry.registerTileEntity(TileEntityFossilPulmonoscorpius.class, PrehistoricNatureFossils.MODID + ":tileentityskeleton_pulmonoscorpius");
    ...
    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
        tooltip.add("When completed contains " + new TileEntityFossilPulmonoscorpius().getStages() + " part(s)");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (playerIn.getHeldItemMainhand().getItem() == Item.getItemFromBlock(this)) {
            if (!worldIn.isRemote) {
                ...
                if (tileEntity != null) {
                    if (tileEntity instanceof TileEntityFossilPulmonoscorpius) {
                        if (((TileEntityFossilPulmonoscorpius) tileEntity).getStages() >= newStage) {
