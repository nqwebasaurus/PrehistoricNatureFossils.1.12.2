...
public class BlockFossilCamptosaurus extends BlockSkeletonBase {

    public BlockFossilCamptosaurus() {
        setRegistryName(PrehistoricNatureFossils.MODID, "skeleton_camptosaurus");
        setTranslationKey("pf_skeleton_camptosaurus");
        GameRegistry.registerTileEntity(TileEntityFossilCamptosaurus.class, PrehistoricNatureFossils.MODID + ":tileentityskeleton_camptosaurus");
